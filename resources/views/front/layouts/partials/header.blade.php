                            ...
                            <div class="header-top-right">
                                ...
                                <div class="switcher-lang-currency">
                                    <div class="lang-switcher">
                                        <span class="flag"><img
                                                src="{{ asset('front/assets/images/language/en.png') }}"
                    ...
                    <div class="header-middle-wrap">
                        <div class="brand-area">
                            <a class="brand-logo" href="{{ url('/') }}"><img class="brand-image"
                                    src="{{ asset('front/assets/images/' . get_setting('logo')) }}"
                                    alt="Fashionwave" /></a>
                        </div>
        ...
        <div class="mobile-menu-area">
            ...
            <nav class="main-menu">
                <ul class="menu-list">
                    ...
                    <li class="menu-item"><a class="menu-link" href="{{ route('category.all') }}">Categories</a></li>
