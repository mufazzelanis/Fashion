                             ...
                             <div class="single-widget">
                                 ...
                                 <ul class="widget-menu show">
                                     @foreach (get_categories() as $category)
                                         <li class="menu-item"><a class="menu-link" href="{{ route('products.bycategory', $category->slug) }}">{{ $category->en_category_name }}</a>
                                         </li>
                                     @endforeach
                                 </ul>
                             </div>
                             ...
                             <div class="single-widget">
                                 ...
                                 <ul class="widget-menu">
                                     ...
                                     <li class="menu-item"><a class="menu-link"
                                             href="{{ route('trems.condition') }}">Terms of
                                             Conditions</a>
                                     </li>
                                     <li class="menu-item"><a class="menu-link"
                                     ...
                                     <li class="menu-item"><a class="menu-link" href="{{ route('contact.us') }}">Contact
                                             Us</a>
                                     </li>
                                 </ul>
                             </div>
     ...
     <div class="footer-bottom">
         <div class="container-fluid">
             <div class="footer-bottom-wrap">
                 Designed &amp; Developed By Mufazzel Hossain
             </div>
         </div>
     </div>
 </footer>
